import { InputFrame, KeyboardFrame, MouseFrame, PointerFrame } from '../../domain/input'
...
export class InputPacketEncoder {
    ...
    private totalSize = -1
    private sequence = -1
    private metadataFrames: Array<any> = []
    ...
    private writeMetadata(packet: DataView, offset: number, frames: Array<any>): number {
    ...
    private writeGamepads(packet: DataView, offset: number, frames: Array<InputFrame>): number {
        packet.setUint8(offset, frames.length)
        offset++
