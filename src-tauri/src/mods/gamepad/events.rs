...
pub const GAMEPAD_INPUT_GATE_CHANGED_CHANNEL: &str = "xbxrc:gamepad:input-gate-changed";
...
pub fn emit_input_gate_changed(app_handle: &AppHandle, payload: &Value) -> Result<(), String> {
    crate::event_bridge::emit_json(app_handle, GAMEPAD_INPUT_GATE_CHANGED_CHANNEL, payload)
}
