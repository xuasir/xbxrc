        ...
        >
          <section class="user-menu__panel" aria-label="User menu">
            ...
            <Focusable
              ...
              @click="emitClose"
            >
              <span class="user-menu__close-line user-menu__close-line--first" aria-hidden="true"></span>
              <span class="user-menu__close-line user-menu__close-line--second" aria-hidden="true"></span>
            </Focusable>
            ...
            <div class="user-menu__block user-menu__block--info">
              <div class="user-menu__avatar-wrap">
                ...
                <span class="user-menu__avatar-online" aria-hidden="true"></span>
              </div>

              <div class="user-menu__identity">
                <div class="user-menu__name-line">
                  <p class="user-menu__display-name">{{ props.displayName }}</p>
                ...
                <div class="user-menu__score-row">
                  ...
                  <p class="user-menu__score">{{ t('userMenu.score', { value: props.score }) }}</p>
                </div>
              </div>
            </div>

            <div class="user-menu__block user-menu__status">
              <span class="user-menu__status-indicator" aria-hidden="true"></span>
              <div class="user-menu__status-copy">
                <p class="user-menu__status-value">{{ props.statusText }}</p>
              </div>
            </div>
