...
<template>
  <section class="xcloud-page ui-page-shell" :aria-label="t('xcloudPage.ariaLabel')">
    ...
    >
      <p class="ui-page-title">{{ t('xcloudPage.limitedTitle') }}</p>
      <p class="ui-page-body">{{ t('xcloudPage.limitedBody') }}</p>
      ...
      <header class="xcloud-page__header">
        <div class="xcloud-page__toolbar">
          <div class="xcloud-page__title-block">
            <p class="xcloud-page__title">{{ activeSectionTitle }}</p>
        ...
        <div class="xcloud-page__filter-bar">
          ...
          <p class="xcloud-page__results">{{ resultCountLabel }}</p>
        </div>
      </header>
