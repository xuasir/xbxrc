...
pub struct XbxEngineMediaRuntimeStats {
    ...
    /// 最近一次 arbiter 决策时的 sparse IDR 压力（与 interval 字段解耦，inactive 时为 false）。
    pub latest_receive_feedback_sparse_active: bool,
    pub receive_feedback_arbiter_mismatch_total: u64,
    pub receive_feedback_coalesced_total: u64,
    pub receive_feedback_throttled_total: u64,
    pub latest_receive_feedback_executor_outcome: Option<String>,
    pub receive_keyframe_sent_count_unresolved: u32,
    pub receive_picture_recovery_terminal_total: u64,
    pub latest_receive_picture_recovery_terminal_reason: Option<String>,
    /// receive-local keyframe_required 闩锁（ledger 投影）。
    ...
    pub reference_stats_fallback_total: u64,
    ...
    pub receive_sparse_must_idr_mismatch_total: u64,
    pub session_picture_recovery_ownership_violation_total: u64,
    pub decoder_reset_violation_total: u64,
    ...
    pub latest_ice_connectivity_probe: Option<XbxEngineIceConnectivityProbeObservation>,
    ...
    pub video_decode_output_mailbox_depth: u32,
    pub video_decode_output_present_pipeline_stressed: bool,
...
impl Default for XbxEngineMediaRuntimeStats {
    fn default() -> Self {
        Self {
            ...
            receive_feedback_decision_seq: 0,
            latest_receive_feedback_action: None,
            latest_receive_feedback_reason: None,
            latest_receive_feedback_coalescing: None,
            latest_receive_feedback_source: None,
            latest_receive_feedback_sparse_active: false,
            receive_feedback_arbiter_mismatch_total: 0,
            receive_feedback_coalesced_total: 0,
            receive_feedback_throttled_total: 0,
            latest_receive_feedback_executor_outcome: None,
            receive_keyframe_sent_count_unresolved: 0,
            receive_picture_recovery_terminal_total: 0,
            latest_receive_picture_recovery_terminal_reason: None,
            receive_keyframe_required: None,
            receive_keyframe_required_cause: None,
            receive_keyframe_response_state: None,
            receive_display_state: None,
            receive_recovery_ledger_generation: None,
            receive_picture_recovery_terminal_candidate: None,
            reference_stats_fallback_total: 0,
            latest_reference_chain_observation_source: None,
            receive_picture_recovery_terminal_elapsed_rtt_count: None,
            reference_chain_state: None,
            reference_chain_state_cause: None,
            reference_chain_decoder_reference_synced: None,
            reference_chain_bootstrap_ready: None,
            reference_chain_has_active_gap: None,
            reference_chain_nack_exhausted: None,
            reference_chain_submit_age_ms: None,
            latest_reference_chain_sparse_must_idr_mismatch: None,
            receive_sparse_must_idr_mismatch_total: 0,
            session_picture_recovery_ownership_violation_total: 0,
            decoder_reset_violation_total: 0,
            ...
            latest_packet_recovery_action_stage: None,
            ...
            latest_ice_connectivity_probe: None,
            ...
            video_decode_output_mailbox_depth: 0,
            video_decode_output_present_pipeline_stressed: false,
