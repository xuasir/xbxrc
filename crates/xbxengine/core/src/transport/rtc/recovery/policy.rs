...
pub(crate) struct RecoveryScenarioProfile {
    ...
    pub(crate) playback_recovered_host_present_fresh_ms: f64,
    pub(crate) playback_recovered_render_submit_fresh_ms: f64,
    ...
    pub(crate) fn resolve_recovery_profile_by_kind(
        ...
        match kind {
            ScenarioPolicyProfileKind::HomeLanGaming => RecoveryScenarioProfile {
                ...
                playback_recovered_host_present_fresh_ms: 120.0,
                playback_recovered_render_submit_fresh_ms: 120.0,
                playback_recovered_track_progress_fresh_ms: 180.0,
                playback_recovered_decode_progress_fresh_ms: 160.0,
                decoded_progress_fresh_ms: 220.0,
                decoded_pending_commit_hold_ms: 180.0,
                pli_refresh_interval_ms: 100.0,
                fir_retry_interval_ms: 260.0,
                post_anchor_continuation_grace_ms: 120.0,
            ...
            ScenarioPolicyProfileKind::CloudGaming => RecoveryScenarioProfile {
                ...
                playback_recovered_host_present_fresh_ms: 220.0,
                playback_recovered_render_submit_fresh_ms: 220.0,
                playback_recovered_track_progress_fresh_ms: 320.0,
                playback_recovered_decode_progress_fresh_ms: 260.0,
                decoded_progress_fresh_ms: 360.0,
                decoded_pending_commit_hold_ms: 320.0,
                pli_refresh_interval_ms: 140.0,
                fir_retry_interval_ms: 420.0,
                post_anchor_continuation_grace_ms: 220.0,
                display_supply_thresholds: DisplaySupplyThresholds {
            ...
            ScenarioPolicyProfileKind::RelayGaming => RecoveryScenarioProfile {
                ...
                playback_recovered_host_present_fresh_ms: 160.0,
                playback_recovered_render_submit_fresh_ms: 160.0,
                playback_recovered_track_progress_fresh_ms: 240.0,
                playback_recovered_decode_progress_fresh_ms: 200.0,
                decoded_progress_fresh_ms: 280.0,
                decoded_pending_commit_hold_ms: 240.0,
                pli_refresh_interval_ms: 120.0,
                fir_retry_interval_ms: 360.0,
                post_anchor_continuation_grace_ms: 160.0,
                display_supply_thresholds: DisplaySupplyThresholds {
                    degraded_no_pending_streak: 64,
                    critical_no_pending_streak: 128,
