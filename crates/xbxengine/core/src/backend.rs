...
use crate::{
    NoopXbxEngineInputBackend, XbxEngineInputBackend, XbxEngineInputStatus, XbxEngineRuntimeError,
};
...
impl XbxEngineMediaBackend for PlaceholderXbxEngineMediaBackend {
    ...
    fn press_controller_button(
        ...
        self.input_backend
            .press_controller_button(&button, duration_ms)?;
        self.last_input_status = self.input_backend.snapshot_status()?;
